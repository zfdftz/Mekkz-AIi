...
const sqlPath = resolve(process.cwd(), "supabase/migration-bump-plan-usage.sql");
...
try {
  ...
  if (!rows.length) {
    throw new Error("Funktion bump_user_plan_usage wurde nicht angelegt.");
  }
  console.log("OK: bump_user_plan_usage ist in Supabase aktiv.");
} catch (error) {
