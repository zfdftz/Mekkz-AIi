...
const de: MessageTable = {
  ...
  "tools.title": "Creative, Business & Advanced KI",
  "tools.subtitle": "{count} Tools — inkl. YouTube- & TikTok-URL-Analyse mit Kommentaren.",
  "tools.backToChat": "← Zurück zum Chat",
  ...
  "tools.availableCount": "{count} verfügbar",
  "tools.pickTool": "Wähle links ein Tool — auf dem Handy scrollst du zur Liste oben.",
  "tools.closeTool": "Tool schließen",
  "tools.uploadInChat": "Upload im Chat →",
  "tools.generate": "Generieren",
  "tools.exportPdf": "PDF exportieren / Drucken",
  "tools.toolFailed": "Tool fehlgeschlagen.",
  "tools.networkError": "Netzwerkfehler.",
  "tools.saveFailed": "Speichern fehlgeschlagen.",
  "tools.logoImageFailed": "Logo-Text ist fertig, aber das Bild konnte nicht erstellt werden: {error}",
  "tools.generatedLogo": "Generiertes Logo",
  "tools.saving": "Speichern…",
  "tools.saveImage": "Bild speichern",
  "tools.generatedLogoAlt": "Generiertes Logo",
  "tools.sources": "Quellen:",
  "tools.result": "Ergebnis",
  "tools.tutor": "KI-Tutor",
  "tools.tutorHint": "Schritt-für-Schritt-Erklärungen, Hausaufgabenhilfe, Quiz und Übungsfragen.",
  "tools.tutorLevel": "Erklärungsniveau",
  "tools.tutorEnabled": "Tutor an",
  "tools.tutorDisabled": "Tutor aus",
  "settingsPage.title": "Einstellungen",
  "settingsPage.subtitle": "Sprache, Kommunikation (Stil-Lernen), Theme, Farben und Konto.",
  "settingsPage.backToChat": "Zurück zum Chat",
  "common.error": "Fehler.",
