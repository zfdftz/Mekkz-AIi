export type TranslationKey =
  ...
  | "settings.customInstructionsSave"
  | "settings.customInstructionsSaved"
  | "settings.customInstructionsSaveError"
  | "tutor.beginner"
  | "tutor.intermediate"
  | "tutor.advanced"
  | "memory.save"
  ...
  | "plan.bullet.slightlyFasterImages"
  | "plan.bullet.slightlyFasterReplies"
  ...
  | "tools.subtitle"
  | "tools.backToChat"
  | "tools.categoryCreative"
  | "tools.categoryBusiness"
  | "tools.categoryAdvanced"
  | "tools.categoryToolsSuffix"
  | "tools.availableCount"
  | "tools.pickTool"
  | "tools.closeTool"
  | "tools.uploadInChat"
  | "tools.generate"
  ...
  | "tools.networkError"
  | "tools.saveFailed"
  | "tools.logoImageFailed"
  | "tools.generatedLogo"
  | "tools.saving"
  | "tools.saveImage"
  | "tools.generatedLogoAlt"
  | "tools.sources"
  | "tools.result"
  | "tools.tutor"
  | "tools.tutorHint"
